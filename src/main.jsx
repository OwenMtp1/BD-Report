...
import DemoJourney from './pages/DemoJourney.jsx'
...
const isTraining = route === 'formation'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <StoreProvider>
      <I18nProvider>
        {isTraining ? <TrainingJourney onClose={leaveOverlay} />
          : isDemo ? <DemoJourney onClose={leaveOverlay} />
            : <App />}
      </I18nProvider>
    </StoreProvider>
  </React.StrictMode>,
