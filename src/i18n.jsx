...
const DICT = {
  ...
  'nav.aide': { fr: 'Aide', en: 'Help', es: 'Ayuda' },
  'nav.supportbdr': { fr: 'Support Client BD Report', en: 'BD Report Customer Support', es: 'Soporte al Cliente BD Report' },
  ...
  'page.support': { fr: 'Support', en: 'Support', es: 'Soporte' },
  'page.requests': { fr: 'Nouvelles demandes', en: 'New requests', es: 'Nuevas solicitudes' },
  ...
  'page.kb': { fr: 'Base de connaissances', en: 'Knowledge base', es: 'Base de conocimientos' },
