...
import { StoreProvider, useStore, trainingSession } from '../store.jsx'
...
const TOUR = [
  {
    page: 'supporthub', hub: 'dashboard', title: 'Le tableau de bord support',
  ...
  {
    page: 'supporthub', hub: 'dashboard', title: 'Clients à risque',
  ...
  {
    page: 'supporthub', hub: 'requests', title: 'Les demandes entrantes',
  ...
  {
    page: 'supporthub', hub: 'tickets', title: 'Prendre un ticket en charge',
  ...
  {
    page: 'supporthub', hub: 'tickets', title: 'Lire le SLA et la priorité',
  ...
  {
    page: 'supporthub', hub: 'clients', title: 'Le portefeuille client',
  ...
  {
    page: 'supporthub', hub: 'projects', title: 'Les projets à paramétrer',
  ...
  {
    page: 'supporthub', hub: 'projects', title: "Rôles et accès d'un client",
  ...
  {
    page: 'supporthub', hub: 'kb', title: 'La base de connaissances',
  ...
  {
    page: 'supporthub', hub: 'permissions', title: 'Les droits du staff',
  ...
  {
    page: 'supporthub', hub: 'orgchart', title: "L'organigramme de l'équipe",
  ...
  {
    page: 'supporthub', hub: 'logs', title: 'Le journal des actions',
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-white flex flex-col" style={{ isolation: 'isolate' }}>
      <div className="shrink-0 flex items-center gap-3 px-3 sm:px-4 h-12 text-white" style={{ background: 'linear-gradient(90deg,#0f2b23,#14513f)' }}>
        ...
        <div className="ml-auto flex items-center gap-2">
          {touring
            ...
            : <button onClick={startTour} className="px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1.5" style={{ background: 'linear-gradient(135deg,#34d399,#0ea5e9)' }}><MousePointerClick size={13} /> Formation guidée</button>}
      ...
      <div className="flex-1 min-h-0 relative overflow-auto bg-app">
        <StoreProvider demo dataset="training">
          <I18nProvider>
